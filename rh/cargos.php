			...
			<header class="header navbar navbar-expand-sm">
				...
				<ul class="navbar-item flex-row ml-md-auto mr-4">
					...
					//BUSCAR DADOS DO REGISTRO A SER EDITADO
								...
								$fun_cargo = $dados[0]['cargo'];
								
								echo 'Edição de cargos';
							}else{
								$nome_botão = 'Salvar';
								echo 'Registro de cargos';
							} ?>
						</b></a>
					</li>
				</ul>
				...
				<form method="post">
					<div class="form-row">
						...
						<div class="form-group col-md-12">
							...
							<input type="text" class="form-control" id="cargo" name="cargo" placeholder="Cargo" value="<?php echo @$fun_cargo ?>" required>
						</div>
					</div>
				</div>
